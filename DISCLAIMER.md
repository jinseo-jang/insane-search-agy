# Disclaimer & Acceptable Use — insane-search for Antigravity

`insane-search for Antigravity` is an independent port based on [fivetaku/insane-search](https://github.com/fivetaku/insane-search),
distributed under the [MIT License](./LICENSE).
Copyright (c) 2026 fivetaku (Upstream Original Work)
Copyright (c) 2026 Jinseo Jang / Antigravity Contributors (Antigravity Port & Enhancements)
