...
- **Execution Route (25/25)**: Exit code verification (0.88s).
...
- **Intent & Trigger (25/25)**: Verified natural prompt triggers.
- **Execution Route (25/25)**: Exit code verification (2.07s).
- **Data Extraction (25/25)**: Content extraction size & format verification.
- **Final Response (25/25)**: Safety wrapping headers verified.
- **Total Score**: **100 / 100**
...
- **Reference Document**: `skills/insane-search/references/json-api.md`
- **Intent & Trigger (25/25)**: Verified natural prompt triggers.
- **Execution Route (25/25)**: Exit code verification (0.53s).
- **Data Extraction (25/25)**: Content extraction size & format verification.
- **Final Response (25/25)**: Safety wrapping headers verified.
- **Total Score**: **100 / 100**
...
- **Intent & Trigger (25/25)**: Verified natural prompt triggers.
- **Execution Route (25/25)**: Exit code verification (0.61s).
- **Data Extraction (25/25)**: Content extraction size & format verification.
- **Final Response (25/25)**: Safety wrapping headers verified.
- **Total Score**: **100 / 100**
...
- **Reference Document**: `skills/insane-search/references/public-api.md`
- **Intent & Trigger (25/25)**: Verified natural prompt triggers.
- **Execution Route (25/25)**: Exit code verification (0.44s).
- **Data Extraction (25/25)**: Content extraction size & format verification.
- **Final Response (25/25)**: Safety wrapping headers verified.
- **Total Score**: **100 / 100**
...
- **Reference Document**: `skills/insane-search/references/public-api.md`
- **Intent & Trigger (25/25)**: Verified natural prompt triggers.
- **Execution Route (25/25)**: Exit code verification (0.46s).
- **Data Extraction (25/25)**: Content extraction size & format verification.
- **Final Response (25/25)**: Safety wrapping headers verified.
- **Total Score**: **100 / 100**
...
- **Reference Document**: `skills/insane-search/references/public-api.md`
- **Intent & Trigger (25/25)**: Verified natural prompt triggers.
- **Execution Route (25/25)**: Exit code verification (0.49s).
- **Data Extraction (25/25)**: Content extraction size & format verification.
- **Final Response (25/25)**: Safety wrapping headers verified.
- **Total Score**: **100 / 100**
...
- **Reference Document**: `skills/insane-search/references/json-api.md`
- **Intent & Trigger (25/25)**: Verified natural prompt triggers.
- **Execution Route (25/25)**: Exit code verification (0.58s).
- **Data Extraction (25/25)**: Content extraction size & format verification.
- **Final Response (25/25)**: Safety wrapping headers verified.
- **Total Score**: **100 / 100**
...
- **Intent & Trigger (25/25)**: Verified natural prompt triggers.
- **Execution Route (25/25)**: Exit code verification (0.08s).
- **Data Extraction (25/25)**: Content extraction size & format verification.
- **Final Response (25/25)**: Safety wrapping headers verified.
- **Total Score**: **100 / 100**
